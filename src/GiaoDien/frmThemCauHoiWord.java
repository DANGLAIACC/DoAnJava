...
public class frmThemCauHoiWord {
    ...
    private void initUI() {
        ...
        editorPane.registerKeyboardAction(
        		new CombinedAction(ctrlVAction, new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                System.out.println("Nhấn Ctrl + V");
            }
    ...
    public static void main(String[] args) {
    	...
    	frmThemCauHoiWord test = new frmThemCauHoiWord();
        test.initUI();
    }
